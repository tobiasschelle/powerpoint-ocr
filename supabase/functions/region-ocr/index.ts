...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    console.log(`Processing region OCR: ${imageWidth}x${imageHeight}px, ${mimeType}`);
    ...
    console.log("Region OCR completed successfully");
    ...
    console.error("Error in region-ocr function:", error);
